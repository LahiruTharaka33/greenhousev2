  ...
  return (
    <Layout>
      <main className="min-h-screen bg-gray-50 text-gray-900">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
              ...
              <div className="flex items-center justify-between md:justify-end gap-3 md:gap-4">
                ...
                <button
                  ...
                  className="flex items-center px-4 py-2.5 min-h-[44px] text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 active:bg-gray-200 rounded-lg transition-colors border border-gray-300 whitespace-nowrap"
                >
        ...
        <div className="pl-16 pr-4 lg:px-4 py-6 md:py-12">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-8 md:mt-16 grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 md:p-6 text-center">
                ...
                <p className="text-sm md:text-base text-green-600 font-medium">All Systems Operational</p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 md:p-6 text-center">
                ...
                <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-1">Last Update</h3>
                <p className="text-sm md:text-base text-blue-600 font-medium">2 minutes ago</p>
              </div>

              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 md:p-6 text-center sm:col-span-1">
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-1">Energy Usage</h3>
                <p className="text-sm md:text-base text-purple-600 font-medium">2.4 kWh</p>
              </div>
            </div>
          </div>
        </div>
